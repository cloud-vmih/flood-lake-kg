...
_ADAPTER_TARGETS: Final[dict[str, tuple[str, str]]] = {
    "existing": ("flashflood_data.static.sources.existing", "ExistingAdapter"),
    "admin_current": ("flashflood_data.static.sources.admin", "CurrentAdminAdapter"),
    "gadm_admin": ("flashflood_data.static.sources.admin", "GadmAdminAdapter"),
    "soilgrids": ("flashflood_data.static.sources.soilgrids", "SoilGridsAdapter"),
    "cop_dem": ("flashflood_data.static.sources.cop_dem", "CopDemAdapter"),
    "worldcover": ("flashflood_data.static.sources.worldcover", "WorldCoverAdapter"),
    "geofabrik_osm": ("flashflood_data.static.sources.osm", "GeofabrikOsmAdapter"),
}
