...
from flashflood_data.catalog.inventory import InventoryRule
...
def test_inventory_cli_marks_run_failed_when_context_construction_fails_once(
    ...
    monkeypatch.setattr(CLI_MODULE, constructor, fail_construction)
...
def test_inventory_cli_marks_run_failed_for_invalid_report(
    ...
    monkeypatch.setattr(CLI_MODULE, "inventory_existing", fake_inventory)
...
def test_inventory_cli_marks_run_failed_when_output_fails(
    ...
    monkeypatch.setattr(CLI_MODULE.typer, "echo", fail_first_output)
